...
public class LeapTrueProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, Entity entity) {
		...
		if (world.getLevelData().getGameRules().getBoolean(BalrviumplusModGameRules.DANGEROUS_LEAP) == true && entity instanceof Player
			...
			entity.hurt(new DamageSource(world.registryAccess().registryOrThrow(Registries.DAMAGE_TYPE).getHolderOrThrow(DamageTypes.FALL)), 99);
			if (entity instanceof ServerPlayer _player) {
				Advancement _adv = _player.server.getAdvancements().getAdvancement(new ResourceLocation("balrviumplus:watchyourstep"));
